...
import model.XinZhuangGongDanZongShu;
public class XinZhuangGongDanZongShuReader {
...
//	       System.out.println(reader.);
	       ...
	       reader.close();
	       List<XinZhuangGongDanZongShu> dList = new ArrayList<>();
	       for (int row = 0;row < List.size(); row++) {
	          int Length=List.get(row).length;
	          if(Length > 0){
	        	  XinZhuangGongDanZongShu dr = new XinZhuangGongDanZongShu();
